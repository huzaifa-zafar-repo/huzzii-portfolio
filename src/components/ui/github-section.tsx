...
const GitHubSection = () => {
  ...
  const username = 'huzaifa-zafar-repo';
  ...
  const fetchGitHubData = async () => {
    try {
      ...
      // Use fallback data directly to avoid API rate limits
      const profile: ProfileData = {
        login: username,
        name: 'Huzaifa Zafar',
        bio: 'Senior Software Engineer | Full Stack Developer',
        public_repos: 50,
        followers: 100,
        following: 50,
        location: 'Pakistan',
        ...
        avatar_url: 'https://github.com/huzaifa-zafar-repo.png',
      };

      // Set fallback repositories data
      const repos: Repository[] = [
        {
          name: 'Portfolio',
          repo: 'https://github.com/huzaifa-zafar-repo/Portfolio',
          description: 'My personal portfolio website built with Next.js and TypeScript',
          demo: 'https://mujtabacodes.tech',
        ...
        },
        {
          ...
          repo: 'https://github.com/huzaifa-zafar-repo/ecommerce-platform',
        ...
        },
        {
          ...
          repo: 'https://github.com/huzaifa-zafar-repo/task-manager',
          description: 'A task management application with drag-and-drop functionality',
          demo: 'https://task-manager-demo.com',
          language: { name: 'React', color: '#61dafb' },
          stars: 18,
          forks: 3,
          updated_at: '2024-01-01T00:00:00Z',
          topics: ['react', 'typescript', 'drag-drop', 'task-management']
        }
      ];
      ...
      console.error('Error setting GitHub data:', err);
    ...
    return (
      <Card className=" rounded-xl p-6 shadow-lg">
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="flex-grow">
            ...
            <div className="lex flex-col gap-1 mb-2">
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  https://github.com/huzaifa-zafar-repo
                </Link>
              </div>
            </div>
          ...
          <img
            src="https://github-readme-stats-salesp07.vercel.app/api/top-langs/?username=huzaifa-zafar-repo&hide=HTML&langs_count=8&layout=compact&theme=react&border_radius=10&size_weight=0.5&count_weight=0.5&exclude_repo=github-readme-stats"
            alt="top langs"
          />
        </div>
      </Card>
      ...
      <Card className=" rounded-xl p-6 shadow-lg">
        ...
        <div className="flex flex-col items-center w-full">
          <div className="grid grid-cols-1 md:grid-cols-2  gap-6 mb-6">
            <img
              src="https://github-readme-stats-salesp07.vercel.app/api?username=huzaifa-zafar-repo&count_private=true&show_icons=true&theme=react&rank_icon=github&border_radius=10"
              alt="readme stats"
            />
            <img
              src="https://github-readme-streak-stats-salesp07.vercel.app/?user=huzaifa-zafar-repo&count_private=true&theme=react&border_radius=10"
              alt="streak stats"
            />
          </div>
          <img
            src="https://github-readme-activity-graph.vercel.app/graph?username=huzaifa-zafar-repo&theme=react-dark&hide_border=true&hide_title=false&area=true&custom_title=Total%20contribution%20graph%20in%20all%20repo"
            width="95%"
            alt="activity graph"
          />
        </div>
